...
#
## Object files
#assembler.o: scripts/assembler.c header/post_formating.h header/first_pass.h header/file.h header/error.h header/word_conversion.h header/symbol_table.h header/line_data.h header/line_node.h header/utilities.h
...
#
#file.o: scripts/file.c header/file.h header/utilities.h header/error.h header/word_conversion.h header/symbol_table.h header/line_node.h
#	$(CC) -c scripts/file.c $(CFLAGS) -o $@
#
#first_pass.o: scripts/first_pass.c header/first_pass.h header/file.h header/error.h header/word_conversion.h header/symbol_table.h header/line_data.h header/line_node.h
...
#
#words_block.o: scripts/word_conversion.c header/word_conversion.h header/symbol_table.h header/line_data.h header/error.h
