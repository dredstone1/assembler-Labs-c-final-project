...
# Object files
assembler.o: scripts/assembler.c header/post_formating.h header/first_pass.h header/file.h header/error.h header/words_block.h header/symbol_table.h header/line_data.h header/line_node.h header/utilitis.h
	$(CC) -c scripts/assembler.c $(CFLAGS) -o $@

error.o: scripts/error.c header/error.h header/utilitis.h header/line_node.h
...
macro.o: scripts/macro.c header/macro.h header/error.h header/line_node.h header/utilitis.h
...
symbol_table.o: scripts/symbol_table.c header/symbol_table.h header/utilitis.h header/error.h
	$(CC) -c scripts/symbol_table.c $(CFLAGS) -o $@

utilitis.o: scripts/utilitis.c header/utilitis.h
